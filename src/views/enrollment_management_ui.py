...
class EnrollmentManagementUI:
    ...
    def create_widgets(self):
        ...
        self.tree = ttk.Treeview(self.window, columns=("id", "student_id", "course_id", "academic_year", "status"), show="headings")
        self.tree.heading("id", text="ID")
        self.tree.heading("student_id", text="Estudiante")
        self.tree.heading("course_id", text="Curso")
    ...
    def process_enrollment(self):
        ...
        if success:
            ...
            # Aquí podrías crear una nueva inscripción para el siguiente año, si fuera necesario.
            self.load_enrollments()
        else:

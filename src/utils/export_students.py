...
def export_students_to_excel(students, output_filename, school_name, logo_path, course_controller):
    ...
    Usa course_controller.get_course_by_id si es necesario para obtener el nombre del curso.
    """
    ...
    def _crear_hoja(wb, sheet_name, data):
        ...
        for st in data:
            course_name = get_course_name(st)
            row_data = [
    ...
    # Hoja final con todos los estudiantes
...
def export_students_to_pdf(students, output_filename, school_name, logo_path, course_controller):
    ...
    Incluye logo y nombre de la escuela como encabezado.
    Usa course_controller.get_course_by_id si es necesario para obtener el nombre del curso.
    """
    ...
    for student in students_sorted:
        course_name = get_course_name(student)
        student["course_id"] = course_name  # Reemplazar course_id por el nombre
        row_data = [
